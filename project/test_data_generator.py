...
class Generator():
    ...
    def generateStudents(self, number_students, percent_fav_projects):
        students = []
        for i in range(number_students):
            student = Student(last_name="Doe", first_name="Joe", matr_number=i, projects_ratings=self.generateProjectsRatings(percent_fav_projects), skills_ratings=self.generateSkillRatings())
    ...
    def generateInstance(self, number_projects, number_students, percent_fav_projects):
        ...
        self.students = self.generateStudents(number_students=number_students, percent_fav_projects=percent_fav_projects)
...
for instance_size in instance_sizes:
    ...
    data = g.generateInstance(number_students = number_students,number_projects = number_projects, percent_fav_projects=10).model_dump_json()
